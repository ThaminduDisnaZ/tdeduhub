                ...
                <div class="h-full bg-white dark:bg-[#0e1726]">
                    <div class="flex items-center justify-between px-4 py-3">
                        <a href="index.html" class="main-logo flex shrink-0 items-center">
                            ...
                            <span
                                class="align-middle text-1xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">WRITER
                                DASHBOARD</span>
                        </a>
                        <a href="javascript:;"
...
for ($i=0; $i < $pn; $i++) { 
    ...
    $commentrs = Database::search(" SELECT * FROM `comment` WHERE `post_id` = '".$pdata["post_id"]."' ");
    ...
    $commentnum += $conum;
                        ...
                        <li class="nav-item">
                            <ul>
                                ...
                                <li class="nav-item">
                                    <a href="writerComment.php" class="group">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Your Comments</span> <span
                                                class="badge bg-success rounded-full"><?php echo $commentnum ?></span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="post.php" class="group">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                ...
                                                Posts</span> <span
                                                class="badge bg-success rounded-full"><?php echo $pnum ?></span>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="category.php" class="group">
                                        <div class="flex items-center">
                                            <i class="fa fa-list"></i>
                                            <span
                                                class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Categories</span>
                                            <span class="badge bg-success rounded-full"><?php echo $cnum ?></span>
                                        </div>
                                    </a>
                                </li>
