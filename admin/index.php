                        ...
                        <div class="mb-6 grid grid-cols-1 gap-6 text-white sm:grid-cols-2 xl:grid-cols-4">
                                ...
                                <div class="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                                    ...
                                    <div class="mt-5 flex items-center">
                                        <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3"><?php echo $uvd["count"];   ?></div>
...
<td><button id="wsb" onclick="changeWriterStatus(<?php echo $wd["writer_id"] ?>);" class="btn btn-warning"><a class="fa-lock">Change Status</a></button></td>
...
<td><button id="wsb" onclick="changeUserStatus(<?php echo $ud["user_id"] ?>);" class="btn btn-warning"><a class="fa-lock">Change Status</a></button></td>
