...
<input type="text" placeholder="Enter Post Title..." class="form-input" value="<?php ?>" required />
...
<button onclick="pedit(<?php echo ($pid) ?>)" class="btn btn-success">Save Changes</button>
