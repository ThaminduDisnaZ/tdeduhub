...
?>
            ...
            for ($i=0; $i < $cnum ; $i++) { 
                ...
                ?> <option value="<?php echo $cdata["category_id"] ?>"><?php echo $cdata["category"] ?></option><?php
            }
            ...
            ?>
                        ...
                        <h1 class="text-2xl">Enter New Content</h1>
                        ...
                        const quill = new Quill('#editor', {
                            ...
                            placeholder: '© 2024. TD EDU HUB All rights reserved.',
                            theme: 'snow',
                        });
                        </script>


                        <div class="grid grid-cols-1 gap-6 mb-5 lg:grid-cols-1 mt-6">
                            <!-- Single File -->
                            <div class="panel">
                                <div class="mb-5 flex items-center justify-between">
                                    <h5 class="text-lg font-semibold dark:text-white-light">Image Upload</h5>


                                    </a>
                                </div>
                                <input type="file" class="hidden" id="imageuploader" />
    ...
    new FileUploadWithPreview.FileUploadWithPreview('myFirstImage', {
        images: {
            baseImage: '../<?php echo $pdata["image"]; ?>',
            backgroundImage: '',
        },
    });
    </script>
